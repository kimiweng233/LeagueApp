...
class Tournament(models.Model):
    ...
    tournamentName = models.CharField(
        max_length=100, default="Unnamed Tournament", unique=True
    )
    tournamentFormat = models.TextField(
        max_length=10, choices=TOURNAMENT_FORMATS, default="5v5"
    )
...
class Team(models.Model):
    ...
    teamJoiningMode = models.TextField(
        max_length=12, choices=TEAM_JOINING_MODES, default="public"
    )
